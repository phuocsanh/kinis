...
const DetailArticleScreen = () => {
  return (
    <View flex>
      <HeaderTitle title="Detail Article" />
      <WebView
        originWhitelist={['*']}
